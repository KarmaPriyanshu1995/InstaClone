...
import { friendsProfileData } from './VideoStorage';
const FriendProfile = ({route, navigation}) => {
  const {name, profileImage, follow, post, followers, following} = route.params;
  return (
    <View
      style={styles.MainConatinor}>
      <View style={styles.HeaderComponentStyleCss}>
        ...
        <View
          ...
          <Text style={{fontSize: 15, marginLeft: 10, fontWeight: 'bold',fontFamily:"Roboto-Bold"}}>
            {name}
          </Text>
          <Feather
            name="more-vertical"
...
const styles = StyleSheet.create({
  ...
  HeaderComponentStyleCss:{flexDirection: 'row', alignItems: 'center'},
